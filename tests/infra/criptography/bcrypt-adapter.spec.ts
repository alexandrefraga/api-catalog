...
describe('Brcypt Adapter', () => {
  describe('hash', () => {
    ...
    it('Should BcrypteAdapter throw if Bcrypt throws', async () => {
      const sut = makeSut()
  ...
  describe('Compare', () => {
    ...
    it('Shoul BcryptAdapter return true when bcrypt compare returns true', async () => {
      const sut = makeSut()
      const isValid = await sut.compare('any_value', 'any_hash')
      expect(isValid).toBe(true)
    })

    it('Shoul BcryptAdapter return false when bcrypt compare returns false', async () => {
      const sut = makeSut()
    ...
    it('Shoul throw if bcrypt compare throws ', async () => {
      const sut = makeSut()
